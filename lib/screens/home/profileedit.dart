                                          ...
                                          onPressed: () async {
                                            ...
                                            String? userId =
                                                await FitbitConnector.authorize(
                                                    context: context,
                                                    clientID:
                                                        Strings.fitbitClientID,
                                                    clientSecret: Strings
                                                        .fitbitClientSecret,
                                                    redirectUri: Strings
                                                        .fitbitRedirectUri,
                                                    callbackUrlScheme: Strings
                                                        .fitbitCallbackScheme);
                                            _currentUserID = userId;
                                            await FitbitConnector.storage
                                                .read(key: 'fitbitAccessToken');
                                            await FitbitConnector.storage.read(
                                            ...
                                            for (var i = 0; i < 7; i++) {
                                              ...
                                              List<FitbitActivityTimeseriesData>?
                                                ...
                                                resource:
                                                    fitbitActivityTimeseriesDataManagerWorkout
                                                      ...
                                                      FitbitActivityTimeseriesData>;
                                              //print(stepData);
                                              var workoutinfo = workoutData
                                                  .toString()
                                                  .split(': ');
                                              String H = workoutinfo[
                                                  workoutinfo.length - 1];
                                              ...
                                              List<FitbitHeartData>
                                                  fitbitHeartData =
                                                  await heartData.fetch(
                                                          fitbitHeartApiUrl)
